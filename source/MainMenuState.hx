...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', #end 'credits', #if !switch 'donate', #end 'options', #end #if charselection 'chaselect'];
